...
[^3]: В русскоязычной версии Excel эта функция называется СУММ. Это важно, потому что если вы напишете название формулы латиницей в русской версии, то ничего работать не будет. Столбцы, однако, в любой локализации обозначаются латиницей.
